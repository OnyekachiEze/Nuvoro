...
const ApplicationPage = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "dob") {
      ...
      setAgeError(age < 15 ? "You must be at least 15 years old to apply." : "");
    }
  };
    ...
    <div>
      ...
      <form className="form-container" onSubmit={handleSubmit}>
        <div className="form-header">
          ...
          <p className="subtitle">Fill out the form accurately. Your tech journey starts now.</p>
        </div>
        ...
        <p className="form-text">Why do you want to join Nuvoro Academy?</p>
        <textarea
          name="reason1"
        ...
        <p className="form-text">How did you hear about Nuvoro Academy?</p>
        <textarea
          name="reason2"
          placeholder="Type your answer here..."
